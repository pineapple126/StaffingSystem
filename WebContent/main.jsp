		...
		<nav class="navbar topnavbar" style="min-height:44px;" role="navigation" >
			...
			<div class="nav-wrapper">
				<ul class="nav navbar-nav navbar-right">
					<li>
						<a>
							<span class="user-name-csdc">欢迎登录：sjm</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<img src="images/StatBar_time.gif">&nbsp;&nbsp;<span id="nowTime"></span>
						</a>
					</li>
			
					<li>
						<a class="menu-icons" title="修改密码" data-search-open="" data-title="修改密码" modal-toggle="modal" data-href="editPassword/editPassword.html" data-width="780" data-height="300">
		...
		<aside class="aside">
			...
			<div class="aside-inner">
				...
				<nav class="sidebar" data-sidebar-anyclick-close="">
					...
					<ul class="nav" id="leftMenuNav"></ul>
