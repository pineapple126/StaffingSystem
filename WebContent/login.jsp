...
<body style="width: 100%; height: 100%; margin: 0; padding: 0;">
	<div class="bg-canvas">
		<canvas id="demo-canvas" width="100%" height="100%"
			style="width: 100%;height: 99%;overflow: hidden;"></canvas>
	</div>
	<div class="login-box" id="loginbox">
		...
		<div class="login" id="main_login">
			...
			<div class="input_text">
				<div id="message"
					style="position: absolute; color: red; margin-top: -20px; margin-left: 100px;">
				</div>
					...
					<div class="content">
						...
						<div class="formitem">
							...
							<span class="input">
								...
								class="form-control l35" fv_type="NOTCN" type="text"
						...
						<div class="formitem">
							...
							<span class="input">
								...
								class="form-control highlight_green l35" fv_type="NOTCN"
								type="password" maxlength="20" placeholder="请输入您的密码"
								data-toggle="tooltip" data-placement="right">
							</span>
						</div>
						...
						<div>
							...
							<button type="button" title="刷脸登录" data-search-open=""
								data-title="刷脸登录" modal-toggle="modal"
								data-href="face/face.html" data-width="780" data-height="500"
								class="layui-btn  btn-login" style="width: 150px">&nbsp;&nbsp;刷
								脸&nbsp;&nbsp;</button>
						</div>
