	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td width="15" height="32">
				<img src="../images/main_locleft.gif" width="15" height="32">
			</td>
			<td class="main_locbg font2">
				<img src="../images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：员工管理&gt; 添加员工
			</td>
			<td width="15" height="32">
				<img src="../images/main_locright.gif" width="15" height="32">
			</td>
		</tr>
	</table>
					...
					<form id="employeeForm" action="AddEmployeeServlet" method="post">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
							<tbody>
									...
									<td class="font3 fftd">
										<table>
											<tbody>
												...
												<tr>
													<td class="font3 fftd">
														学历：<input name="education" id="education" size="20">
													</td>
													<td class="font3 fftd">
														邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱：
												...
												<tr>
													<td class="font3 fftd">
														手机：<input name="phone" id="phone" size="20">
													</td>
													<td class="font3 fftd">
														电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话：
														<input name="tel" id="tel" size="20">
													</td>
												</tr>
											</tbody>
										</table>
								...
								<tr>
									<td class="font3 fftd">
										所属薪资范围： <select name="levelid" style="width: 300px;">
											<c:forEach items="${levels}" var="level">
												<option value="${level.id}">${level.range}</option>
											</c:forEach>
										</select> 
										&nbsp;&nbsp;薪&nbsp;&nbsp;&nbsp;&nbsp;资：<input name="salary" id="salary" size="20">
									</td>
								</tr>
								<tr>
									<td class="main_tdbor"></td>
								...
								<tr>
									<td align="left" class="fftd">
										<input type="button" onclick="submitAddEmployee()" value="添加">&nbsp;&nbsp;
