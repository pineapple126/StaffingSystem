	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			// 2.处理请求
	      	...
	      	employeeService.addEmployee(name, cardid, sex, Integer.parseInt(jobid), education, email, phone, tel, party, qqnum, address, postcode, birthday, race, speciality, hobby, remark, Integer.parseInt(depid), Integer.parseInt(levelid), Double.parseDouble(salary));
